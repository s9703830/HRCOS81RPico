...
void DFRobot_EC::initKValues(float kvalueLow, float kvalueHigh)
{
    this->_kvalueLow  = kvalueLow;    //buffer solution 4.0 at 25C
    this->_kvalueHigh = kvalueHigh;     //buffer solution 7.0 at 25C
}
...
boolean DFRobot_EC::cmdSerialDataAvailable()
{
    ...
    while (Serial.available()>0) 
    {
        ...
        if(cmdReceivedChar == '\r'){
            // swallow carrage return chars for windows terminals
        }else{
