...
public:
   ...
   /**
   * @fn begin
   * @brief Initialization The Calibration K values to override EEPROM stored values. Must be called after begin
   */
    void initKValues(float kvalueLow, float kvalueHigh);
